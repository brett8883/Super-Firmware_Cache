# MavicPro/MPP Super-Patcher 2.0 Stealth Variant
...
AIRCRAFT MODEL:MavicPro, Mavic Pro Platinum, or Mavic Pro Alpine White

REQUIRED STOCK FW VERSION: v01.04.0300

FLIGHT CONTROLLER version #: 03.02.44.21
...
• Note: rear light will activate during start up and may also turn on if an aircraft error is present.
