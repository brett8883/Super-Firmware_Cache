# DJI Phantom 4 Pro Super-Patcher 2.0 *NO GALILIEO* FLIGHT CONTROLLER

## P4P_SP_2.0_No_gal_standard_03.02.44.99_dji_system.bin
...
Galileo GPS Satellites reception **DISABLED**

Unlocked DJI battery parameters (factory defaults remain defaults)
...
• Standard P4P Super-Patcher 2.0 flight controller with the Galileo GNSS settings DISABLED. GPS settings remain at factory defaults. Explicit commands to GNSS receiver to configure settings equal to factory defaults. Will over ride existing settings
...
100% stock v1.05.0600 firmware required
