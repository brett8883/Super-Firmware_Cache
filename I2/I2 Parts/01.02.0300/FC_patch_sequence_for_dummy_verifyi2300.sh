...
#
#   updated for inspire 2 1.02.0300 fc version v03.03.09.18 by digdat0 @ 9/11/2019 # freedom
...
then
   #   I2 = Inspire2
   AC_PREFIX=wm620
   FULL_ORIGINAL_FIRMWARE_VERSION="v01.02.0300" # changed 
   ORI_VERSION="03.03.09.18" # changed
   ORI_FILEDATE=20180921  # changed
   ORI_MODULE_TIMESTAMP="2018-11-22 04:22:05" # changed
   #escape the / from <\module> after copy/pasting the original data here
