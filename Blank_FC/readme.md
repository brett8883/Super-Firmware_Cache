# DJI Super-Patcher ([FILL IN])  FLIGHT CONTROLLER
...
AIRCRAFT MODEL:([FILL IN]) 

REQUIRED STOCK FW VERSION: ([FILL IN]) 

FLIGHT CONTROLLER version # ([FILL IN]) 
...
To use this Custom firmware, your aircraft MUST BE ON STOCK FW:([FILL IN])
...
Full Change Log for Super-Patcher Standard ([FILL IN])  DJI Super-Patcher Custom Flight Controller
...
Widened MIN/MAX Yaw speed range for P-GPS with OA sensors ON *(Default value remains factory default)*
...
Widened MIN/MAX Yaw speed range for P-GPS with OA sensors OFF *(Default value remains factory default)*

		"minValue" : 1.000000,
		"maxValue" : 300.000000,
		"defaultValue" : 90.000000,
		"name" : "g_config.mode_normal_cfg.tors_gyro_range" *(Default value remains factory default)*
...
Widened MIN/MAX Yaw speed range for beginner mode
		...
		"maxValue" : 300.000000,
		"defaultValue" : 70.000000,
		"name" : "g_config.mode_gentle_cfg.tors_gyro_range" *(Default value remains factory default)*

Widened MIN/MAX Yaw speed range for sport mode *(Default value remains factory default)*
...
Widened MIN/MAX Yaw speed range for Cinematic mode *(Default value remains factory default)*
...
Widened MIN/MAX Yaw speed range for tripod mode *(Default value remains factory default)*

		"minValue" : 1.000000,
		"maxValue" : 300.000000,
		"defaultValue" : 15.000000,
		"name" : "g_config.mode_tripod_cfg.tors_gyro_range" *(Default value remains factory default)*
...
Widened MIN/MAX Yaw speed range for waypoint mode *(Default value remains factory default)*
...
Widened MIN/MAX vertical speed range in tripod mode *(Default value remains factory default)*
